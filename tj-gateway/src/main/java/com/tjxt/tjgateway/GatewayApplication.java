...
public class GatewayApplication {
    ...
    /*
     * 启动入口。
     * 注意：必须是 public static void main —— Spring Boot 打包插件（repackage）与 java -jar 都依赖它；
     * 若写成 Java 25 的实例 main（void main），打包会报 "Unable to find main class"。
     */
