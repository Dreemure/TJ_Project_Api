...
import com.tjxt.tjmicroservice.proto.QueryQuestionByIdsRequest;
import com.tjxt.tjmicroservice.proto.QueryQuestionIdsByBizIdsRequest;
...
public class ExamGrpcClient {
     ...
     */
    private final ExamServiceGrpc.ExamServiceBlockingStub stub;
    ...
    private com.tjxt.tjmicroservice.proto.QuestionBizDTO convertToProtoQuestionBiz(
            QuestionBizDTO biz) {
        if (biz == null) {
            return com.tjxt.tjmicroservice.proto.QuestionBizDTO.getDefaultInstance();
        }
        return com.tjxt.tjmicroservice.proto.QuestionBizDTO.newBuilder()
    ...
    private QuestionBizDTO convertToBizQuestionBiz(
            com.tjxt.tjmicroservice.proto.QuestionBizDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private QuestionDTO convertToBizQuestion(
            com.tjxt.tjmicroservice.proto.QuestionDTO proto) {
        if (proto == null) {
            return null;
        }
