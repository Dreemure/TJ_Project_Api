...
import com.tjxt.tjmicroservice.proto.CountLearningLessonByCourseRequest;
import com.tjxt.tjmicroservice.proto.IsLessonValidRequest;
import com.tjxt.tjmicroservice.proto.LearningServiceGrpc;
import com.tjxt.tjmicroservice.proto.QueryLearningRecordByCourseRequest;
...
public class LearningGrpcClient {
     ...
     */
    private final LearningServiceGrpc.LearningServiceBlockingStub stub;
    ...
    private LearningLessonDTO convertToBizDTO(
            com.tjxt.tjmicroservice.proto.LearningLessonDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private List<LearningRecordDTO> convertRecords(
            List<com.tjxt.tjmicroservice.proto.LearningRecordDTO> protoRecords) {
