...
import com.tjxt.tjmicroservice.proto.CheckMyLessonRequest;
import com.tjxt.tjmicroservice.proto.CountEnrollCourseOfStudentRequest;
import com.tjxt.tjmicroservice.proto.CountEnrollNumOfCourseRequest;
import com.tjxt.tjmicroservice.proto.GetPurchaseInfoOfCourseRequest;
...
public class TradeGrpcClient {
    ...
    private CoursePurchaseInfoDTO convertToBizDTO(
            com.tjxt.tjmicroservice.proto.CoursePurchaseInfoDTO proto) {
        if (proto == null) {
            return new CoursePurchaseInfoDTO();
        }
