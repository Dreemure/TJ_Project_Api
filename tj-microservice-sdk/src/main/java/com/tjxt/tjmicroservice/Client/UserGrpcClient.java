...
import com.tjxt.tjmicroservice.proto.ExchangeUserIdWithPhoneRequest;
import com.tjxt.tjmicroservice.proto.ExchangeUserIdWithPhoneResponse;
import com.tjxt.tjmicroservice.proto.QueryUserByIdRequest;
import com.tjxt.tjmicroservice.proto.QueryUserByIdsRequest;
import com.tjxt.tjmicroservice.proto.QueryUserDetailRequest;
import com.tjxt.tjmicroservice.proto.QueryUserTypeRequest;
...
public class UserGrpcClient {
     ...
     */
    private com.tjxt.tjmicroservice.proto.LoginFormDTO convertToProtoLoginForm(
            LoginFormDTO biz) {
        if (biz == null) {
            return com.tjxt.tjmicroservice.proto.LoginFormDTO.getDefaultInstance();
        }
        return com.tjxt.tjmicroservice.proto.LoginFormDTO.newBuilder()
    ...
    private LoginUserDTO convertToBizLoginUser(
            com.tjxt.tjmicroservice.proto.LoginUserDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private UserDTO convertToBizUser(
            com.tjxt.tjmicroservice.proto.UserDTO proto) {
        if (proto == null) {
            return null;
        }
        var dto = new UserDTO();
