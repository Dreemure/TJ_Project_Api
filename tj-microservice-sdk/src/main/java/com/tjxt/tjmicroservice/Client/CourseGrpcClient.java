...
import com.tjxt.tjmicroservice.Model.Dto.Course.CataSimpleInfoDTO;
...
import com.tjxt.tjmicroservice.Model.Dto.Course.CourseFullInfoDTO;
import com.tjxt.tjmicroservice.Model.Dto.Course.CourseSearchDTO;
...
import com.tjxt.tjmicroservice.Model.Dto.Course.SubNumAndCourseNumDTO;
import com.tjxt.tjmicroservice.Model.Dto.Course.SubjectDTO;
import com.tjxt.tjmicroservice.proto.BatchQueryCatalogueRequest;
import com.tjxt.tjmicroservice.proto.CourseServiceGrpc;
import com.tjxt.tjmicroservice.proto.GetCourseInfoByIdRequest;
import com.tjxt.tjmicroservice.proto.GetSearchInfoRequest;
import com.tjxt.tjmicroservice.proto.InfoByTeacherIdsRequest;
import com.tjxt.tjmicroservice.proto.MediaUserInfoRequest;
import com.tjxt.tjmicroservice.proto.QueryByIdsRequest;
import com.tjxt.tjmicroservice.proto.SectionInfoRequest;
...
public class CourseGrpcClient {
    ...
    private CataSimpleInfoDTO convertToBizCataSimpleInfo(
            com.tjxt.tjmicroservice.proto.CataSimpleInfoDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private CategoryBasicDTO convertToBizCategory(
            com.tjxt.tjmicroservice.proto.CategoryBasicDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private SubNumAndCourseNumDTO convertToBizSubNumAndCourseNum(
            com.tjxt.tjmicroservice.proto.SubNumAndCourseNumDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private SectionInfoDTO convertToBizSectionInfo(
            com.tjxt.tjmicroservice.proto.SectionInfoDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private MediaQuoteDTO convertToBizMediaQuote(
            com.tjxt.tjmicroservice.proto.MediaQuoteDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private CourseSearchDTO convertToBizCourseSearch(
            com.tjxt.tjmicroservice.proto.CourseSearchDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private CourseFullInfoDTO convertToBizCourseFullInfo(
            com.tjxt.tjmicroservice.proto.CourseFullInfoDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private CatalogueDTO convertToBizCatalogue(
            com.tjxt.tjmicroservice.proto.CatalogueDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private SubjectDTO convertToBizSubject(
            com.tjxt.tjmicroservice.proto.SubjectDTO proto) {
        if (proto == null) {
            return null;
        }
