package com.example.tjmicroservice.Model.Dto.User;

import com.example.tjcommon.Constants.RegexConstants;
import com.example.tjcommon.Validate.Annotations.EnumValid;
...
/*
 * 用户详情 DTO。
 * 职责：承载用户的完整信息（联系方式、身份、角色、个人资料等），用于用户管理与展示。
 */
@Data
