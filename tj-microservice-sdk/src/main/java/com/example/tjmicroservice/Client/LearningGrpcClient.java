...
import com.example.tjmicroservice.Model.Dto.Leanring.LearningLessonDTO;
import com.example.tjmicroservice.Model.Dto.Leanring.LearningRecordDTO;
import com.example.tjmicroservice.proto.CountLearningLessonByCourseRequest;
import com.example.tjmicroservice.proto.IsLessonValidRequest;
import com.example.tjmicroservice.proto.LearningServiceGrpc;
import com.example.tjmicroservice.proto.QueryLearningRecordByCourseRequest;
...
public class LearningGrpcClient {
    ...
    private LearningLessonDTO convertToBizDTO(
            com.example.tjmicroservice.proto.LearningLessonDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private List<LearningRecordDTO> convertRecords(
            List<com.example.tjmicroservice.proto.LearningRecordDTO> protoRecords) {
