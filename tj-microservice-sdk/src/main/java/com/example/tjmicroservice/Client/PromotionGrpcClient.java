...
import com.example.tjcommon.Exceptions.BizIllegalException;
import com.example.tjmicroservice.Model.Dto.Promotion.CouponDiscountDTO;
...
import com.example.tjmicroservice.Model.Dto.Promotion.OrderCourseDTO;
import com.example.tjmicroservice.proto.FindDiscountSolutionRequest;
import com.example.tjmicroservice.proto.FindDiscountSolutionResponse;
import com.example.tjmicroservice.proto.PromotionServiceGrpc;
import com.example.tjmicroservice.proto.QueryDiscountDetailByOrderRequest;
import com.example.tjmicroservice.proto.QueryDiscountDetailByOrderResponse;
import com.example.tjmicroservice.proto.QueryDiscountRulesRequest;
import com.example.tjmicroservice.proto.RefundCouponRequest;
import com.example.tjmicroservice.proto.WriteOffCouponRequest;
...
public class PromotionGrpcClient {
    ...
    private OrderCourseDTO convertOrderCourse(
            com.example.tjmicroservice.proto.OrderCourseDTO proto) {
        if (proto == null) {
            return null;
        }
