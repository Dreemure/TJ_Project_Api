...
import com.example.tjmicroservice.Model.Dto.Exam.QuestionBizDTO;
import com.example.tjmicroservice.Model.Dto.Exam.QuestionDTO;
import com.example.tjmicroservice.proto.ExamServiceGrpc;
import com.example.tjmicroservice.proto.QueryQuestionByIdsRequest;
import com.example.tjmicroservice.proto.QueryQuestionIdsByBizIdsRequest;
import com.example.tjmicroservice.proto.QueryQuestionScoresByBizIdsRequest;
import com.example.tjmicroservice.proto.QueryQuestionScoresRequest;
import com.example.tjmicroservice.proto.SaveQuestionBizInfoBatchRequest;
...
public class ExamGrpcClient {
     ...
     */
    private com.example.tjmicroservice.proto.QuestionBizDTO convertToProtoQuestionBiz(
            QuestionBizDTO biz) {
        if (biz == null) {
            return com.example.tjmicroservice.proto.QuestionBizDTO.getDefaultInstance();
        }
        return com.example.tjmicroservice.proto.QuestionBizDTO.newBuilder()
    ...
    private QuestionBizDTO convertToBizQuestionBiz(
            com.example.tjmicroservice.proto.QuestionBizDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private QuestionDTO convertToBizQuestion(
            com.example.tjmicroservice.proto.QuestionDTO proto) {
        if (proto == null) {
            return null;
        }
