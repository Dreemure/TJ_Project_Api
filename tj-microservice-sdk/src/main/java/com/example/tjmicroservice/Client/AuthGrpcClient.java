...
import com.example.tjmicroservice.proto.AuthServiceGrpc;
import com.example.tjmicroservice.proto.QueryRoleByIdRequest;
...
public class AuthGrpcClient {
    ...
    private RoleDTO convertToBizRole(
            com.example.tjmicroservice.proto.RoleDTO proto) {
        if (proto == null) {
            return null;
        }
        var dto = new RoleDTO();
