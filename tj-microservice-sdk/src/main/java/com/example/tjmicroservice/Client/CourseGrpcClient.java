package com.example.tjmicroservice.Client;

import com.example.tjmicroservice.Model.Dto.Course.CataSimpleInfoDTO;
import com.example.tjmicroservice.Model.Dto.Course.CatalogueDTO;
import com.example.tjmicroservice.Model.Dto.Course.CategoryBasicDTO;
import com.example.tjmicroservice.Model.Dto.Course.CourseFullInfoDTO;
import com.example.tjmicroservice.Model.Dto.Course.CourseSearchDTO;
import com.example.tjmicroservice.Model.Dto.Course.MediaQuoteDTO;
import com.example.tjmicroservice.Model.Dto.Course.SectionInfoDTO;
import com.example.tjmicroservice.Model.Dto.Course.SubNumAndCourseNumDTO;
import com.example.tjmicroservice.Model.Dto.Course.SubjectDTO;
import com.example.tjmicroservice.proto.BatchQueryCatalogueRequest;
import com.example.tjmicroservice.proto.CourseServiceGrpc;
import com.example.tjmicroservice.proto.GetCourseInfoByIdRequest;
import com.example.tjmicroservice.proto.GetSearchInfoRequest;
import com.example.tjmicroservice.proto.InfoByTeacherIdsRequest;
import com.example.tjmicroservice.proto.MediaUserInfoRequest;
import com.example.tjmicroservice.proto.QueryByIdsRequest;
import com.example.tjmicroservice.proto.SectionInfoRequest;
...
public class CourseGrpcClient {
    ...
    private CataSimpleInfoDTO convertToBizCataSimpleInfo(
            com.example.tjmicroservice.proto.CataSimpleInfoDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private CategoryBasicDTO convertToBizCategory(
            com.example.tjmicroservice.proto.CategoryBasicDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private SubNumAndCourseNumDTO convertToBizSubNumAndCourseNum(
            com.example.tjmicroservice.proto.SubNumAndCourseNumDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private SectionInfoDTO convertToBizSectionInfo(
            com.example.tjmicroservice.proto.SectionInfoDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private MediaQuoteDTO convertToBizMediaQuote(
            com.example.tjmicroservice.proto.MediaQuoteDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private CourseSearchDTO convertToBizCourseSearch(
            com.example.tjmicroservice.proto.CourseSearchDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private CourseFullInfoDTO convertToBizCourseFullInfo(
            com.example.tjmicroservice.proto.CourseFullInfoDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private CatalogueDTO convertToBizCatalogue(
            com.example.tjmicroservice.proto.CatalogueDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private SubjectDTO convertToBizSubject(
            com.example.tjmicroservice.proto.SubjectDTO proto) {
        if (proto == null) {
            return null;
        }
