...
import com.example.tjmicroservice.Model.Dto.Course.CoursePurchaseInfoDTO;
import com.example.tjmicroservice.proto.CheckMyLessonRequest;
import com.example.tjmicroservice.proto.CountEnrollCourseOfStudentRequest;
import com.example.tjmicroservice.proto.CountEnrollNumOfCourseRequest;
import com.example.tjmicroservice.proto.GetPurchaseInfoOfCourseRequest;
import com.example.tjmicroservice.proto.TradeServiceGrpc;
...
public class TradeGrpcClient {
    ...
    private CoursePurchaseInfoDTO convertToBizDTO(
            com.example.tjmicroservice.proto.CoursePurchaseInfoDTO proto) {
        if (proto == null) {
            return new CoursePurchaseInfoDTO();
        }
