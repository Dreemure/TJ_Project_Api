...
import com.example.tjmicroservice.Model.Dto.User.UserDTO;
import com.example.tjmicroservice.proto.ExchangeUserIdWithPhoneRequest;
import com.example.tjmicroservice.proto.ExchangeUserIdWithPhoneResponse;
import com.example.tjmicroservice.proto.QueryUserByIdRequest;
import com.example.tjmicroservice.proto.QueryUserByIdsRequest;
import com.example.tjmicroservice.proto.QueryUserDetailRequest;
import com.example.tjmicroservice.proto.QueryUserTypeRequest;
import com.example.tjmicroservice.proto.UserServiceGrpc;
...
public class UserGrpcClient {
     ...
     */
    private com.example.tjmicroservice.proto.LoginFormDTO convertToProtoLoginForm(
            LoginFormDTO biz) {
        if (biz == null) {
            return com.example.tjmicroservice.proto.LoginFormDTO.getDefaultInstance();
        }
        return com.example.tjmicroservice.proto.LoginFormDTO.newBuilder()
    ...
    private LoginUserDTO convertToBizLoginUser(
            com.example.tjmicroservice.proto.LoginUserDTO proto) {
        if (proto == null) {
            return null;
        }
    ...
    private UserDTO convertToBizUser(
            com.example.tjmicroservice.proto.UserDTO proto) {
        if (proto == null) {
            return null;
        }
        var dto = new UserDTO();
