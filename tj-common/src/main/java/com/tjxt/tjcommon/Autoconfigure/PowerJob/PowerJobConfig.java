package com.tjxt.tjcommon.Autoconfigure.PowerJob;
...
// 必须显式配置 powerjob.worker.app-name 才会启用：避免只引了依赖、没接 PowerJob Server 的服务启动即报错
@ConditionalOnProperty(prefix = "powerjob.worker", name = "app-name")
