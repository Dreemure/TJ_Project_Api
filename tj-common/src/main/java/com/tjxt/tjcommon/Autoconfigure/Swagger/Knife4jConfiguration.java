package com.tjxt.tjcommon.Autoconfigure.Swagger;

import cn.hutool.core.convert.ConverterRegistry;
import com.tjxt.tjcommon.Utils.TjTemporalConverter;
...
@ConditionalOnClass({OpenAPI.class, GroupedOpenApi.class})   // 网关等未引入 springdoc 的模块自动跳过
@ConditionalOnWebApplication(type = ConditionalOnWebApplication.Type.SERVLET)  // 网关是响应式，文档由 knife4j-gateway 聚合
