package com.tjxt.tjcommon.Autoconfigure.Redisson.Aspect;

import com.tjxt.tjcommon.Autoconfigure.Redisson.Annotations.Lock;
 ...
 * 说明：不作为 @Component（库内包不在业务服务扫描范围），由 RedissonConfig 以 @Bean 注册（仅有 RedissonClient 时）。
 */
@Aspect
