...
import com.tjxt.tjcommon.Autoconfigure.Mvc.Advice.CommonExceptionAdvice;
import com.tjxt.tjcommon.Autoconfigure.Mvc.Advice.WrapperResponseBodyAdvice;
import com.tjxt.tjcommon.Autoconfigure.Mvc.Converter.WrapperResponseMessageConverter;
import com.tjxt.tjcommon.Filters.RequestIdFilter;
...
public class MvcConfig implements WebMvcConfigurer {
    ...
    /*
     * 注意：FastJsonHttpMessageConverter 不在这里注册。
     * 它与 Fastjson2Config#fastJsonHttpMessageConverter 同名，两个自动配置同时生效会抛
     * BeanDefinitionOverrideException（Spring Boot 默认禁止 Bean 覆盖）导致服务启动失败；
     * 统一由 Fastjson2Config 注册，这里只按类型注入使用。
     */
