...
import com.tjxt.tjcommon.Enums.CommonStatus;
...
import com.tjxt.tjcourse.Mapper.CategoryMapper;
import com.tjxt.tjcourse.Mapper.SubjectCategoryMapper;
...
import com.tjxt.tjcourse.Utils.CategoryDataWrapper;
import com.tjxt.tjcourse.Utils.CategoryDataWrapper2;
...
public class CategoryServiceImpl extends ServiceImpl<CategoryMapper, Category> implements ICategoryService {
    ...
    @Resource(name = "taskExecutor") // 按名称注入
    ...
    public void add(CategoryAddDTO categoryAddDTO) {
        ...
        if (this.baseMapper.insert(category) <= 0) {
            throw new com.tjxt.tjcommon.Exceptions.DbException("分类添加失败");
        }
    }
    ...
    public void delete(Long id) {
        ...
        //2.1.判空
        if (category == null) {
            throw new com.tjxt.tjcommon.Exceptions.DbException(ErrorInfo.Msg.DB_DELETE_EXCEPTION);
        }
        //3.统计分类拥有的课程数量
        ...
        if (result <= 0) {
            throw new com.tjxt.tjcommon.Exceptions.DbException(CourseErrorInfo.Msg.CATEGORY_DELETE_FAILD);
        }
    }
