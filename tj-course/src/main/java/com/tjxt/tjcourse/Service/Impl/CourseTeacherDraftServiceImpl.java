...
import com.tjxt.tjcommon.Utils.BeanUtils;
...
import com.tjxt.tjcourse.Mapper.CourseTeacherDraftMapper;
...
import com.tjxt.tjcourse.Service.ICourseTeacherDraftService;
import com.tjxt.tjcourse.Service.ICourseTeacherService;
...
public class CourseTeacherDraftServiceImpl extends ServiceImpl<CourseTeacherDraftMapper, CourseTeacherDraft> implements ICourseTeacherDraftService {
    ...
    private List<CourseTeacherVO> queryTeachers(Long couserId) {
        ...
        // 3.组织为map
        Map<Long, Object> UserDTOMap = UserDTOS.stream().collect(Collectors.toMap(UserDTO::getId, UserDTO -> UserDTO));

        //4.数据组装
        return BeanUtils.copyList(courseTeacherDrafts, CourseTeacherVO.class,
                (courseTeacher, courseTeacherVO) -> {
                    //4.1.老师信息
                    UserDTO teacherDetailDTO = (UserDTO) UserDTOMap.get(courseTeacher.getTeacherId());
