...
import com.tjxt.tjcommon.Autoconfigure.Mq.StreamMqHelper;
import com.tjxt.tjcommon.Constants.ErrorInfo;
import com.tjxt.tjcommon.Constants.MqConstants;
import com.tjxt.tjcommon.Exceptions.BadRequestException;
import com.tjxt.tjcommon.Exceptions.BizIllegalException;
import com.tjxt.tjcommon.Exceptions.DbException;
import com.tjxt.tjcommon.Model.Dto.PageDTO;
import com.tjxt.tjcommon.Utils.*;
...
import com.tjxt.tjcourse.Entity.*;
import com.tjxt.tjcourse.Mapper.*;
import com.tjxt.tjcourse.Model.Dto.CourseBaseInfoSaveDTO;
import com.tjxt.tjcourse.Model.Dto.CoursePageQuery;
import com.tjxt.tjcourse.Model.Vo.CourseBaseInfoVO;
import com.tjxt.tjcourse.Model.Vo.CoursePageVO;
import com.tjxt.tjcourse.Model.Vo.CourseSaveVO;
import com.tjxt.tjcourse.Model.Vo.NameExistVO;
...
import com.tjxt.tjmicroservice.Model.Dto.Course.CourseDTO;
import com.tjxt.tjmicroservice.Model.Dto.Course.CoursePurchaseInfoDTO;
import com.tjxt.tjmicroservice.Model.Dto.Exam.QuestionBizDTO;
...
public class CourseDraftServiceImpl extends ServiceImpl<CourseDraftMapper, CourseDraft> implements ICourseDraftService {
    ...
    @Autowired
    private UserGrpcClient userClient;

    @Autowired
    private ICategoryService categoryService;

    @Autowired
    private StreamMqHelper rabbitMqHelper;

    @Autowired
    private TradeGrpcClient tradeClient;

    @Autowired
    private ExamGrpcClient examClient;

    @Autowired
    private LearningGrpcClient learningClient;
    ...
    public void updateStep(Long id, Integer step) {
        ...
        updateCourseDraft.setStep(Math.max(courseDraft.getStep(), step));
    ...
    public void upShelf(Long id) {
        ...
        //5.课程上架mq
        rabbitMqHelper.send(MqConstants.Binding.COURSE_UP_OUT, id);
    }
    ...
    public void downShelf(Long id) {
        ...
        //8.下架mq广播
        rabbitMqHelper.send(MqConstants.Exchange.COURSE_EXCHANGE,id);
    }
    ...
    public NameExistVO checkName(String name, Long id) {
        ...
        //2.统计同名课程数量
        int num = Math.toIntExact(baseMapper.selectCount(queryWrapper));
        //3.返回同名课程VO
