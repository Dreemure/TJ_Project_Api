...
public class CoursePageQuery extends PageQuery { //自动生成 equals() 和 hashCode() 方法，包括父类
    ...
    @Schema(description = "课程状态，1：待上架，2：已上架，3：已下架，4：已完结",example = "1",requiredMode = Schema.RequiredMode.REQUIRED)
